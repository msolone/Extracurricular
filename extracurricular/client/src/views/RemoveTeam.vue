<template>
    <section class="remove_team_section">
      ...
      <section class="my-teams-dropdown">
        ...
        <button class="remove_team_button" type="submit" :disabled="isDisabled" v-on:click.prevent="deleteTeam" data-toggle="modal" data-target="#exampleModalCenter">Remove</button>
